          ...
          <div className="row center-xs project__row_container">
            <div className="col-xs-9 col-md-6">
              <div className="box project__header">
                ...
                <p>
                  This is a collection of projects that I accomplished in a way
                  to learn, to practice and the most common reason to be doing
                  something :).
                </p>
              </div>
            </div>
                  ...
                  <div className="project__container">
                    <a href="https://facefinder.surge.sh/" target="_blank">
                      ...
                      <p className="portfolio_project__description project--pbottom">
                        This is an app that identify the faces in a picture. I'm
                        using Clarifai API to detect the presence and location
                        of human faces with a bounding box.
                      </p>
                    </a>

                    <a
                      href="https://facefinder.surge.sh/"
                      target="_blank"
                ...
                <div className="box">
                  <div className="project__container">
                    <a href="https://tip.surge.sh/" target="_blank">
                      ...
                      <p className="portfolio_project__description project--pbottom">
                        Calculates gratuity based on meal or service total.
                        Enter the total cost and the tip percentage you would
                        like to include as gratuity.
                      </p>
                    </a>

                    <a
                      href="https://tip.surge.sh/"
                      target="_blank"
                      className="btn btn--border btn--round"
                    >
                      {" "}
                ...
                <div className="box">
                  <div className="project__container">
                    <a href="https://moviefinder.surge.sh" target="_blank">
                      ...
                      <h2 className="portfolio_project__title">Movie Finder</h2>
                      <p className="portfolio_project__description project--pbottom">
                        This application finds movies that match with the search
                        text that has been introduced.This application uses
                        themoviedb API.
                      </p>
                    </a>

                    <a
                      href="https://moviefinder.surge.sh"
                      target="_blank"
                      className="btn btn--border btn--round"
                    >
                      {" "}
                ...
                <div className="box">
                  <div className="project__container">
                    <a href="/projects/css-js-clock/index.html" target="_blank">
                      ...
                      <p className="portfolio_project__description project--pbottom">
                        This is a Challenge part of the{" "}
                        <strong>wesbos Javascript30</strong>. I added some extra
                        functionalities: the background change according the
                        time.
                      </p>
                    </a>

                    <a
                      href="/projects/css-js-clock/index.html"
                      target="_blank"
                      className="btn btn--border btn--round"
                    >
                      {" "}
